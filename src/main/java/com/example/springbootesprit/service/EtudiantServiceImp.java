...
public class EtudiantServiceImp implements IEtudiantService{
    ...
    public String generecarteetudpdf(long idEtudiant) {
        ...
        try {
            ...
            String reportPath = "C:\\carteetudiant";

            // Compile the Jasper report from .jrxml to .japser
            JasperReport jasperReport = JasperCompileManager
                    .compileReport(new ClassPathResource("carte_etudiantEtudiant.jrxml.xml")
                            .getInputStream());
            ...
            JasperExportManager.exportReportToPdfFile(jasperPrint, reportPath + "\\carteEtudiant.pdf");
